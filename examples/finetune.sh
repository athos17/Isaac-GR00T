...
EPISODE_START_MARGIN="${EPISODE_START_MARGIN:-0}"
EPISODE_END_MARGIN="${EPISODE_END_MARGIN:-0}"
...
LAUNCH_CMD=(
    ...
    --episode_start_margin "$EPISODE_START_MARGIN"
    --episode_end_margin "$EPISODE_END_MARGIN"
)
